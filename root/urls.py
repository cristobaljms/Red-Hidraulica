...
from proyectos.views import CalculosGradiente, obtenerProyectoDatos, ProyectosListView, ProyectosCreateView, ProyectosUpdateView, ProyectoDeleteView, ProyectoAdminView, borrarTuberia, borrarNodo, borrarReservorio
...
urlpatterns = [
    ...
    path('calculos/gradiente/<int:pk>/', login_required(CalculosGradiente, login_url='/login/'), name='calculo_gradiente'),
